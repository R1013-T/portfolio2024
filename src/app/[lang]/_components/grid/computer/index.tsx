...
export default async function ComputerGrid({ lang }: { lang: string }) {
  return (
    <article className="h-full w-full p-4">
      <div className="h-5/6 lg:h-[calc(100dvh-30px)] lg:overflow-y-hidden max-w-7xl mx-auto md:flex-wrap gap-2 lg:flex-nowrap hidden border-2 rounded-3xl p-3 md:flex">
